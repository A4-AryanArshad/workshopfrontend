                ...
                <div>
                  ...
                  <div>
                    {filteredAllBookings.map((booking) => (
                      <div key={booking._id} style={{ background: selectedBooking?._id === booking._id ? '#333' : '#232323', padding: 16, borderRadius: 12, marginBottom: 12, border: `2px solid ${selectedBooking?._id === booking._id ? '#ffd700' : '#333'}`, cursor: 'pointer' }} onClick={() => selectBooking(booking)}>
          ...
          <div className="grid">
            ...
            <div className="admin-sidebar">
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
                  {filteredAllBookings.map((booking) => (
                    <div key={booking._id} style={{ background: selectedBooking?._id === booking._id ? '#333' : '#232323', padding: 20, borderRadius: 12, marginBottom: 16, border: `2px solid ${selectedBooking?._id === booking._id ? '#ffd700' : '#333'}`, cursor: 'pointer', transition: 'all 0.2s ease' }} onClick={() => selectBooking(booking)}>
                ...
                <>
                  ...
                  <div style={{ background: '#232323', padding: 20, borderRadius: 12, border: '1px solid #333', marginBottom: 20 }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, color: '#fff', marginBottom: 20 }}>
                      <div><strong style={{ color: '#ffd700' }}>Service:</strong> {selectedBooking.service.label}</div>
